...
export default function Page() {
  ...
  const handleAddClaim = (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    ...
    const newClaim: Claim = {
      ...
      claimDetails: formData.get("claimDetails") as string,
      status: "Pending",
  ...
  const updateClaimStatus = (id: number, status: "Approved" | "Denied") => {
    setClaims(
