...
function Sidebar() {
  return (
    <div className="w-48 h-screen bg-blue-950 py-10 p-4 shadow-2xl">
      ...
      <ul className="flex flex-col  justify-start items-center mt-4">
        <li>
          <Link
      ...
      <ul className="flex flex-col  justify-center mt-4 ml-6">
        <li>
          <Link
            className="flex items-start justify-center gap-4  hover:text-blue-500"
            href={"/transactions"}
          >
            <AiOutlineDashboard size={22} color="white" />
            <h1 className="text-sm">Date-wise Transactions</h1>
          </Link>
        </li>
      </ul>
